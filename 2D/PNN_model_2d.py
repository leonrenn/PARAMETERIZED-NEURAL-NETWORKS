...
class ParameterizedNeuralNet(pl.LightningModule):
    def __init__(self, llr_analysis=False):
        """Neural Network parameterized with hypothesis
        of signal and background means.
        """
        super().__init__()
        ...
        self.net = nn.Sequential(
            nn.Linear(in_features=6, out_features=20),
            nn.PReLU(),
        ...
        # deciding if the output will come from the
        # sigmoid layer or from last neuron
